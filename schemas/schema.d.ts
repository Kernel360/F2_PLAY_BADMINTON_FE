...
}
{
  ...
  cookie?: never;
  ("application/json");
  : components["schemas"]["LeagueCreateRequest"]
  /** @description OK */
  200;
  :
  [name: string]
  ...
  cookie?: never;
  ("multipart/form-data");
  : components["schemas"]["ImageUploadRequest"]
  /** @description OK */
  200;
  :
  [name: string]
  ...
  cookie?: never;
  ("application/json");
  : components["schemas"]["ClubUpdateRequest"]
  /** @description OK */
  200;
  :
  [name: string]
  ...
  cookie?: never;
  ("application/json");
  : components["schemas"]["LeagueUpdateRequest"]
  /** @description OK */
  200;
  :
  [name: string]
